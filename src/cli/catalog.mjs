...
export const commandCatalog = [
  ...
  },
  {
    ...
    api: ["GET https://api.github.com/repos/hikariming/ghfind/releases/latest", "GET release asset"],
    output: ["json", "pretty"],
    response_semantics:
      "With --method binary, downloads the current platform release asset and atomically replaces the local ghfind binary. With --method npm|pip|brew, runs the matching package-manager upgrade command.",
    agent_guidance:
      "Use --dry-run first to show the exact target asset or package-manager command. Use this only when the user explicitly asks to upgrade the local CLI install.",
    auth: "Does not require authentication.",
    args: [],
    options: ["--method", "--release-url", "--asset-url", "--target", "--dry-run", "-o, --output"],
  },
  {
    name: "update npm",
    ...
    api: [],
    output: ["json", "pretty"],
    response_semantics: "Runs npm install -g ghfind@latest unless --dry-run is set.",
    agent_guidance: "Use when ghfind was installed from npm. Prefer --dry-run before executing in automation.",
    auth: "Does not require authentication.",
    args: [],
    options: ["--dry-run", "-o, --output"],
  },
  {
    name: "update pip",
    ...
    api: [],
    output: ["json", "pretty"],
    response_semantics: "Runs python3 -m pip install --upgrade ghfind unless --dry-run is set.",
    agent_guidance: "Use when ghfind was installed from PyPI. Prefer --dry-run before executing in automation.",
    auth: "Does not require authentication.",
    args: [],
    options: ["--dry-run", "-o, --output"],
  },
  {
    ...
    api: [],
    output: ["json", "pretty"],
    response_semantics: "Runs brew upgrade ghfind unless --dry-run is set.",
    agent_guidance: "Use when ghfind was installed from Homebrew. Prefer --dry-run before executing in automation.",
    auth: "Does not require authentication.",
    args: [],
    options: ["--dry-run", "-o, --output"],
  },
